...
%
% Doc 4b v7: BDT calibration update.
%   BDT cross-check now uses SF-calibrated 3-tag extraction
%   (same method as cut-based). Uncalibrated R_b = 0.095-0.123
%   becomes calibrated R_b = 0.217, consistent with SM.
%   Updated Section 6.7 and Appendix B with calibrated BDT results.
% Compiled with: tectonic ANALYSIS_NOTE_doc4b_v7.tex
